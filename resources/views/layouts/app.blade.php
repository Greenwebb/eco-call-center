...
<div class="aside-logo py-8" id="kt_aside_logo">
    ...
    <a href="{{route('dashboard')}}" class="d-flex align-items-center">
        <img alt="Logo" src="{{ asset('public/img/logo.png')}}" class="h-45px logo" />
    </a>
    <!--end::Logo-->
</div>
<!--end::Brand-->
                ...
                <div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px mh-75 overflow-auto">
                    ...
                    <div class="menu-item">
                        ...
                        <div class="menu-content">
                            <span class="menu-section fs-5 fw-bolder ps-1 py-1">Quick Tools</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                    <!--end:Menu item-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="#">
                                    ...
                                    <span class="menu-title">View Subscriptions</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 fw-semibold my-5 my-lg-0 px-2 px-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                            ...
                            <span class="menu-link py-3">
                                <span class="menu-title requestAdvise">Get Advise</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/index#" class="menu-link">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/ecommerce#" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/projects#" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/online-courses#" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/marketing#" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/bidding#" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/pos#" class="menu-link">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/call-center#" class="menu-link active">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                                ...
                                                <a href="../../demo6/dist/landing#" class="btn btn-sm btn-primary fw-bold">Explore</a>
                                            </div>
                                            <!--end:Landing-->
                                        </div>
                                        <!--end:Col-->
                                        ...
                                        <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/logistics#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/website-analytics#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/finance-performance#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/store-analytics#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/social#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/delivery#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/crypto#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/school#" class="menu-link py-2">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo6/dist/dashboards/podcast#" class="menu-link py-2">
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link py-3" href="##https://preview.keenthemes.com/metronic8/demo6/layout-builder#" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        <span class="menu-icon">
                        ...
                        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="##../../demo6/dist/pages/search/horizontal#" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end::Preferences-->
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        ...
                        <div class="row g-0">
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="##../../demo6/dist/apps/projects/budget#" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="##../../demo6/dist/apps/projects/settings#" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="##../../demo6/dist/apps/projects/list#" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="##../../demo6/dist/apps/projects/users#" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                        ...
                        <div class="py-2 text-center border-top">
                            <a href="##../../demo6/dist/pages/user-profile/activity#" class="btn btn-color-gray-600 btn-active-color-primary">View All
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5">
                            <a href="##../../demo6/dist/account/overview#" class="menu-link px-5">My Profile</a>
                        </div>
                        end::Menu item-->
                        <!--begin::Menu item
                        <div class="menu-item px-5">
                            <a href="##../../demo6/dist/apps/projects/list#" class="menu-link px-5">
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="##../../demo6/dist/account/statements#" class="menu-link d-flex flex-stack px-5">Statements
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="###" class="menu-link px-5">My Requests</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu separator-->
                        <div class="separator my-2"></div>
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
        ...
        <div class="flex-grow-1 flex-shrink-0 me-5">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Call Center</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="" target="_blank" class="text-gray-800 text-hover-primary">Ecoagro</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
		...
		<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
			<div class="card shadow-none border-0 rounded-0">
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											<!--begin::Title-->
											<a href="##../../demo6/dist/apps/projects/project#" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
											<!--end::Title-->
											<!--begin::Label-->
											...
											<!--end::Progress-->
											<!--begin::Action-->
											<a href="##../../demo6/dist/apps/projects/project#" class="btn btn-sm btn-light btn-active-light-primary">View</a>
											<!--end::Action-->
										</div>
										<!--end::Record-->
										<!--begin::Record-->
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											<!--begin::Title-->
											<a href="##../../demo6/dist/apps/projects/project#" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
											<!--end::Title-->
											<!--begin::Label-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												...
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
													<a href="##../../demo6/dist/apps/projects/project#" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
													<!--end::Desc-->
													<!--begin::Number-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo6/dist/apps/projects/project#" class="w-30px me-3" src="assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo6/dist/apps/projects/project#" class="w-30px me-3" src="assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
				...
				<div class="card-footer py-5 text-center" id="kt_activities_footer">
					<a href="##../../demo6/dist/pages/user-profile/activity#" class="btn btn-bg-body text-primary">View All Activities
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="##../../demo6/dist/apps/ecommerce/sales/details#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="##../../demo6/dist/apps/ecommerce/sales/details#" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="##../../demo6/dist/apps/ecommerce/sales/details#" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="##../../demo6/dist/apps/ecommerce/sales/details#" class="text-gray-800 text-hover-primary fs-4 fw-bold">KD Printer</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="##../../demo6/dist/apps/ecommerce/sales/details#" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="##../../demo6/dist/apps/ecommerce/sales/details#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
		...
		<!-- Modal HTML -->
		<div id="myNewRequestModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel">Advisory Request</h4>
						<button type="button" class="close btn btn-xs rounded-full" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
					<div class="modal-body">
						<!-- Expanded Modal content goes here -->
						<form id="advisoryRequestForm" enctype="multipart/form-data">
							<!-- Other form fields... -->
							...
							<div class="form-group mt-2">
								...
								<select class="form-control" id="preferred-contact-method" name="preferred_contact_method">
							...
							<div class="form-group mt-2">
								<label for="file-upload">Attachment Files:</label>
								<div class="custom-file">
									<input type="file" class="custom-file-input" id="file-upload" name="file_upload" multiple>
									<label class="custom-file-label" for="file-upload">Choose file(s)</label>
								</div>
								<span id="file-badge" class="badge badge-primary">0 files selected</span>
							</div>


							<button type="submit" class="btn btn-primary mt-4">Ask Now</button>
						</form>
					</div>
		...
		<script>
			$(document).ready(function () {
				$('.requestAdvise').click(function(){
					$('#myNewRequestModal').modal('show');
				});
			});

			// Get file input and file badge elements
			var fileInput = document.getElementById('file-upload');
			var fileBadge = document.getElementById('file-badge');

			// Update the file badge with the current number of selected files
			fileInput.addEventListener('change', function() {
				var selectedFiles = fileInput.files;
				var numSelectedFiles = selectedFiles.length;
				
				if (numSelectedFiles === 0) {
					fileBadge.textContent = '0 files selected';
				} else {
