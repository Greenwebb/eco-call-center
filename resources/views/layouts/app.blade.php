                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/index.html" class="menu-link">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo6/dist/dashboards/call-center.html" class="menu-link active">
                                                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="../../demo6/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fs-4 fw-bold">KD Printer</a>
