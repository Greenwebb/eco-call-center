...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
            ...
            <div class="col-xl-3">
                <!--begin::Card widget 3-->
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #123d37;background-image:url('assets/media/svg/shapes/wave-bg-purple.svg')">
                    <!--begin::Header-->
                    <div class="card-header pt-5 mb-3">
                        <!--begin::Icon-->
                        <div class="d-flex flex-center rounded-circle h-80px w-80px" style="border: 1px dashed rgba(255, 255, 255, 0.4);background-color: #122e0f">
                            <i class="ki-outline ki-call text-white fs-2qx lh-0"></i>
                        </div>
                        <!--end::Icon-->
                    </div>
                    ...
                    <div class="card-footer" style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
                        ...
                        <div class="fw-bold text-white py-2">
                            <span class="fs-1 d-block">0</span>
                            <span class="opacity-50">Advisories</span>
                        </div>
                        <!--end::Progress-->
                    </div>
                    <!--end::Card footer-->
            ...
            <div class="col-xl-3">
                <!--begin::Card widget 3-->
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #7a1e1e;background-image:url('assets/media/svg/shapes/wave-bg-purple.svg')">
                    <!--begin::Header-->
                    <div class="card-header pt-5 mb-3">
                        <!--begin::Icon-->
                        <div class="d-flex flex-center rounded-circle h-80px w-80px" style="border: 1px dashed rgba(255, 255, 255, 0.4);background-color: #ea3939">
                            <i class="ki-outline ki-call text-white fs-2qx lh-0"></i>
                        </div>
                        <!--end::Icon-->
                    </div>
                    ...
                    <div class="card-header pt-5 mb-6">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <!--begin::Currency-->
                                <span class="fs-3 fw-semibold text-gray-400 align-self-start me-1">K</span>
                                <!--end::Currency-->
                                <!--begin::Value-->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K2,756.26</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K3,207.03</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K3,274.94</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                    ...
                                    <table class="table align-middle gs-0 gy-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K2,145.55</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                    ...
                                    <table class="table align-middle gs-0 gy-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K2,346.25</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K1,565.26</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                    ...
                                    <table class="table align-middle gs-0 gy-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K3,756.26</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K1,474.04</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                    ...
                                    <table class="table align-middle gs-0 gy-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K1,756.25</span>
                                                </td>
                                                <td class="pe-0 text-end">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    <span class="text-gray-800 fw-bold fs-6 me-1">K2,034.65</span>
                                                </td>
                                                <td class="pe-0 text-end">
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="../../demo6/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">K78.34%</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="../../demo6/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">K63.83%</span>
                                        </td>
                                        <td class="text-end pe-12">
                                            <!--begin::Label-->
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="../../demo6/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">K92.56%</span>
                                        </td>
                                        <td class="text-end pe-12">
                                            <!--begin::Label-->
                                            <span class="badge badge-light-success fs-base">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="../../demo6/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">K64.02%</span>
                                        </td>
                                        <td class="text-end pe-12">
                                            <!--begin::Label-->
                                            <span class="badge badge-light-success fs-base">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="../../demo6/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
                                        ...
                                        <td class="text-end pe-0">
                                            <span class="text-gray-600 fw-bold fs-6">K89.31%</span>
                                        </td>
                                        <td class="text-end pe-12">
                                            <!--begin::Label-->
                                            <span class="badge badge-light-danger fs-base">
